...
func (diaryHandler *DiaryHandler) GetDiaryList(c *gin.Context) {
	var req model_dto.GetDiaryListRequest
	...
	diaryList, err := diaryHandler.service.GetDiaryList(
		c.Request.Context(),
		userID,
		req.Page,
		req.PageSize,
